...
with gr.Blocks(css=customCSS, theme=small_and_beautiful_theme) as demo:
    ...
    with gr.Row():
        ...
        status_display = gr.Markdown("jp", elem_id="status_display")
...
if __name__ == "__main__":
    ...
    # if not running in Docker
        ...
        if authflag:
            ...
            demo.queue(concurrency_count=CONCURRENT_COUNT).launch(server_name="0.0.0.0", server_port=4399, share=False) # 可自定义端口
